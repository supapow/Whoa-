...
export async function convertTextLayerToVectors(
  ...
  if (mode === 'single') {
    ...
    const singleLayer: Layer = {
      ...
      shadowX: textLayer.shadowX,
      shadowY: textLayer.shadowY,
      shadowSpread: textLayer.shadowSpread,
      shadowOpacity: textLayer.shadowOpacity,
      innerShadowEnabled: textLayer.innerShadowEnabled,
      innerShadowColor: textLayer.innerShadowColor,
      innerShadowBlur: textLayer.innerShadowBlur,
      innerShadowX: textLayer.innerShadowX,
      innerShadowY: textLayer.innerShadowY,
      innerShadowSpread: textLayer.innerShadowSpread,
      innerShadowOpacity: textLayer.innerShadowOpacity,
